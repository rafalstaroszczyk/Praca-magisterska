\begin{tikzpicture}
	\begin{axis}[width=0.7\textwidth,
		...
		\addplot[domain=V1:V2] {1/r * 1/tau / x} node [pos=0.5, below, sloped] {$T_c$};
		\addplot[mark=none] coordinates {(V1, p2) (V1, p3)};
		\addplot[domain=V1:V2] {1/r / x}         node [pos=0.5, above, sloped] {$T_h$};
		\addplot[mark=none] coordinates {(V2, p4) (V2, p1)};
		%\addplot[domain=0.8*V2:1.15*V2, dashed] {1/r^kappa * 1/tau * 1/x} node [pos=1, above, sloped] {$T_1$};
		%\addplot[domain=0.9*V1:1.25*V1, dashed] {1/r * 1/x} node [pos=0.75, above, sloped] {$T_2$};
