\tikzsetnextfilename{pv_silnik_endo_stirling}
\begin{tikzpicture}
	\begin{axis}[width=\textwidth,
		...
		\addplot[domain=V1:V2] {1/r * 1/tau / x} node [pos=0.5, below, sloped] {$T_{cw}$};
		...
		\draw[line width=0.3mm, -{Stealth[length=5mm, open]}] (0.8,0.3) -- (0.75,0.2) node[anchor=north east]{$Q_{1-2}$};
		
		\addplot[domain=V1:V2, dashed] {0.7*1/r * 1/tau / x} node [pos=0.5, below, sloped] {$T_c$};
