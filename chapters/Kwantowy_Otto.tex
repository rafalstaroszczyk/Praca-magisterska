...
\end{multline}
Podobnie jak dla przypadku oscylatora harmonicznego należy to wyrażenie zmaksymalizować numerycznie. Obliczenia te przeprowadzono używając programów zawartych w plikach \ref{pr:otto_harm_osc} oraz \ref{pr:otto_P}. Zależność sprawnośći od stosunku temperatur przedstawiono na rysunku \ref{fig:otto_spin_pol_PT}.
