...
\end{equation}
Oznacza to, że dwie przemiany izochoryczne w analizie są identyczne jak dwie przemiany izentropowe cyklu Carnota. Ciepło tych przemian nie jest też brane pod uwagę, ponieważ wymieniane jest ono z wewnętrznym regeneratorem, a nie z otoczeniem. Problem ten sprowadza się więc do analizy cyklu Carnota w punkcie maksymalnej mocy i nie będzie powtórzona. Wyniki końcowe są następujace:
\begin{gather}
