...
\begin{align*}
	...
	W_{4-1} &= 0.
\end{align*}
Parametrem kontrolowanym przez nas jest \(\omega\). Rozpatrujemy przypadek w granicy niskiego oddziaływania z otoczeniem. W tym przypadku stan stacjonarny jest stanem równowagi termodynamicznej opisywanym rozkładem Boltzmanna \cite{endo_otto}. Wzory opisujące \(U\) i \(\vu{\rho}\) w bazie wektorów własnych oscylatora harmonicznego maja postać:
\begin{gather*}
