...
\chapter{Cząstka w prostopadłościennej nieskończonej studni potencjału}
...
\begin{equation*}
	\Psi\pab{x,y,z} = \sum_{n_1,n_2,n_3} a_{n_1,n_2,n_3} \psi_{n_1,n_2,n_3}\pab{x,y,z}.
\end{equation*}
Kwadraty współrzędnych \(a_{n_1,n_2,n_3}\) mają sens prawdopodobieństwa znalezienia cząstki w danym stanie:
\begin{equation*}
	p_{n_1,n_2,n_3} = \vab{a_{n_1,n_2,n_3}}^2.
\end{equation*}
