...
\section{Entropia układów kwantowych}\label{sec:entropia_kwantowa}
...
\begin{equation*}
	F = - \inv{\beta} \ln Z.
\end{equation*}
Prawdziwość tej równości możemy zweryfikować posługując się znanymi tożsamościami \cite{b:pudlik_termodynamika, lobejko}:
\begin{gather*}
