...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Wykres sprawności kwantowego silnika Stirlinga z oscylatorem harmonicznym jako czynnikiem roboczym; wykorzystano jednostki naturalne \(k_B = 1\), \(\hbar = 1\); stosunek temperatur jest równy \(\frac{T_h}{T_c} = 3\); w tych warunkach sprawność silnika Carnota jest równa \(\eta_C = \frac{2}{3}\).}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Wykres sprawności kwantowego silnika Stirlinga z oscylatorem harmonicznym jako czynnikiem roboczym i bez regeneratora; wykorzystano jednostki naturalne \(k_B = 1\), \(\hbar = 1\); stosunek temperatur jest równy \(\frac{T_h}{T_c} = 3\); w tych warunkach sprawność silnika Carnota jest równa \(\eta_C = \frac{2}{3}\).}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Wykres sprawności kwantowego silnika Stirlinga z układem o spinie \(\inv{2}\) jako czynniku roboczym; wykorzystano jednostki naturalne \(k_B = 1\), \(\hbar = 1\); stosunek temperatur jest równy \(\frac{T_h}{T_c} = 3\); w tych warunkach sprawność silnika Carnota jest równa \(\eta_C = \frac{2}{3}\).}
