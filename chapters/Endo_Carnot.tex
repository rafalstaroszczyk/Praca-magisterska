...
\end{equation*}
które ma dwa rozwiązania rzeczywiste, ale tylko jedno z nich jest fizyczne i spełniające \(x_0/T_{h} < 1\). Następnie wykorzystując \eqref{eq:endo_carnot_y} mamy:
